...
/***/ function(module, exports, __webpack_require__) {
	...
	var _eligibility = __webpack_require__(160);

	var _eligibility2 = _interopRequireDefault(_eligibility);

	var _details = __webpack_require__(162);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _infobox = __webpack_require__(161);
	...
	var Eligibility = function (_Component) {
	    _inherits(Eligibility, _Component);

	    function Eligibility(props) {
	        _classCallCheck(this, Eligibility);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Eligibility).call(this, props));

	        _this.showInfoBox = _this.showInfoBox.bind(_this);
	        _this.state = { infoStyle: 'none' };
	        return _this;
	    }

	    _createClass(Eligibility, [{
	        key: 'showInfoBox',
	        value: function showInfoBox() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement('input', { type: 'radio', name: 'circumstance', ref: 'enrolled' }),
	                        'I am enrolled to vote in Australia and I am not a member of any other Australian political party.'
	                    ),
	                    _react2.default.createElement(
	                        'label',
	                        { onClick: this.showInfoBox },
	                        _react2.default.createElement('input', { type: 'radio', name: 'circumstance', ref: 'resident' }),
	                        'I am a permanent resident in Australia and I am not a member of any other Australian political party.'
	                    ),
	                    _react2.default.createElement(
	                        'label',
	                        { onClick: this.showInfoBox },
	                        _react2.default.createElement('input', { type: 'radio', name: 'circumstance', ref: 'member' }),
	                        'I am a member of at least one other Australian political party and I wish to support the Pirate Party.'
	                    ),
	                    _react2.default.createElement(
	                        'label',
	                        { onClick: this.showInfoBox },
	                        _react2.default.createElement('input', { type: 'radio', name: 'circumstance', ref: 'international' }),
	                        'I do not live in Australia and wish to be an international supporter.'
	                    ),
	                    _react2.default.createElement(_infobox2.default, { display: this.state.infoStyle })
	                ),
	                _react2.default.createElement(
	                    'div',
	...
	var InfoBox = function (_Component) {
	    ...
	    _createClass(InfoBox, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                "div",
	                { className: "info-box", style: { display: this.props.display } },
	                _react2.default.createElement(
	                    "div",
