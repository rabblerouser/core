...
function resetDB() {
  return models.Address.truncate({cascade: true})
  .then(() => {
      return models.Member.truncate({cascade: true});
  })
  .then(() => {
      return models.AdminUser.truncate({cascade: true});
  })
  .then(() => {
      return models.BranchGroup.truncate({cascade: true});
  })
  .then(() => {
      return models.Group.truncate({cascade: true});
  })
  .then(() => {
      return models.Branch.truncate({cascade: true});
  });
}
