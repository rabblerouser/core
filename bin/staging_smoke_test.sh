...
NODE_ENV=test INSTANCE_URL=https://project-m-staging.herokuapp.com node --harmony node_modules/jasmine/bin/jasmine.js spec/integration/newMemberSignsUpAndMakesAPaymentSpec.js
